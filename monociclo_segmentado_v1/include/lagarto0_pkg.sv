...
// Parametros par extensor de signo

localparam 		SE_IMM				= 52;
localparam 		SE_JAL				= 44;


// Data Cache
localparam		DCACHE_LINE_SIZE	= 64;
localparam		DBLOCK_BYTE			= DCACHE_LINE_SIZE / 8;
localparam		DLINE_BYTE_OFFSET	= $clog2(DBLOCK_BYTE);
localparam		DCACHE_SIZE 		= 1024 * 2;
localparam		DCACHE_MEM_DEPTH 	= DCACHE_SIZE / DBLOCK_BYTE;
localparam		DCACHE_IDX_SIZE	= $clog2(DCACHE_MEM_DEPTH);
localparam		DCACHE_VPN_SIZE	= VADD_SIZE - DCACHE_IDX_SIZE - DLINE_BYTE_OFFSET;
